...
public class KithWebSocket {

    private static final Logger LOG = Logger.getLogger(KithWebSocket.class);
...
var members = userRepo.listMembers(false);
            ...
            if (permissionService.hasServerPermission(userId, chat.kith.security.Permission.MANAGE_CHANNELS)) {
